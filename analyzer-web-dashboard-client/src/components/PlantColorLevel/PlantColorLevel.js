...
const PlantColorLevel = () => {
    ...
    return (
        <Card>
            <Card.Header>
                <Card.Title as="h5"><i className="fas fa-chart-line text-success mr-2"></i> Plant Growth - Leaf Color </Card.Title>
            </Card.Header>
            <Card.Body>
                <canvas ref={chartRef} />
            </Card.Body>
...
export default PlantColorLevel;
